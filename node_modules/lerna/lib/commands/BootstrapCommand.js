...
function handler(argv) {
  ...
  var cmd = new BootstrapCommand([].concat(_toConsumableArray(argv.args)), argv, argv._cwd);
  ...
  _createClass(BootstrapCommand, [{
    ...
    value: function initialize(callback) {
      ...
      if (npmClient === "yarn" && typeof hoist === "string") {
        return callback(new _ValidationError2.default("EWORKSPACES", _dedent2.default`
    ...
    value: function installExternalDependencies(callback) {
      ...
      if (Object.keys(root).length) {
        ...
        actions.push(function (actionDone) {
          if (depsToInstallInRoot.length) {
            tracker.info("hoist", "Installing hoisted dependencies into root");
          }

          _NpmUtilities2.default.installInDir(_this6.repository.rootPath, depsToInstallInRoot, _this6.npmConfig, function (installError) {
            if (installError) {
