...
var NpmUtilities = function () {
  ...
  _createClass(NpmUtilities, null, [{
    ...
    value: function publishTaggedInDir(tag, directory, _ref5, callback) {
      var _ref5$client = _ref5.client,
          client = _ref5$client === undefined ? "npm" : _ref5$client,
          registry = _ref5.registry;

      _npmlog2.default.silly("publishTaggedInDir", tag, _path2.default.basename(directory));

      var opts = NpmUtilities.getExecOpts(directory, registry);
      _ChildProcessUtilities2.default.exec(client, ["publish", "--tag", tag.trim()], opts, callback);
    }
  }, {
    key: "getExecOpts",
